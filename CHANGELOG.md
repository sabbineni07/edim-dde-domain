...
- Phase 0 engineer docs: reference architecture + PPT deck, environments, security, PII, LangSmith setup, **pluggable observability**, YAML schema, orchestration topology
